...
public extension UIView {
    ...
    */
    ...
    func makeToastCenter(message msg: String) {
        makeToast(message: msg, duration: 4.0, position: HRToastPositionDefault as AnyObject)
    }
    func makeToastMiddle(message msg: String) {
        makeToast(message: msg, duration: 4.0, position: HRToastPositionCenter as AnyObject)
    }
